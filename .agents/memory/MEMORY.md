...
- [Expo port constraints](expo-port.md) — Expo workflow CWD is artifact dir (not workspace root); use `pnpm run dev` not `--filter`; bridge secrets in dev script; PORT injected by artifact.toml.
