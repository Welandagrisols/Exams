...
const SIDEBAR_SUBTEXT = "#a5b4fc";
const SIDEBAR_BORDER = "rgba(165,180,252,0.2)";
    ...
    <div style={{ fontFamily: "'Poppins', sans-serif" }} className="flex h-screen bg-slate-50 overflow-hidden text-slate-800">
      ...
      <aside className="w-64 flex-shrink-0 flex flex-col relative z-20" style={{ backgroundColor: SIDEBAR_BG }}>
        <div className="p-6 flex items-center gap-3">
          <div className="p-2 rounded-xl" style={{ backgroundColor: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.1)" }}>
            <GraduationCap className="h-8 w-8" style={{ color: SIDEBAR_SUBTEXT }} />
          </div>
          <div>
        ...
        <div className="p-4 mt-auto">
          ...
          <div className="mt-4 pt-4 flex items-center gap-3 px-4 pb-2" style={{ borderTop: `1px solid ${SIDEBAR_BORDER}` }}>
            <Avatar className="h-10 w-10"><AvatarImage src="https://i.pravatar.cc/150?u=teacher" /><AvatarFallback className="text-white" style={{ backgroundColor: "#4338ca" }}>TR</AvatarFallback></Avatar>
            ...
            <div className="grid grid-cols-3 gap-8">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" className="text-indigo-600 font-semibold rounded-full">View All</Button>
                </div>
              ...
              <div className="col-span-2 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" className="text-indigo-600 font-semibold rounded-full">Full Leaderboard</Button>
                </div>
