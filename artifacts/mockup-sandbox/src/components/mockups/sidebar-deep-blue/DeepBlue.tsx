...
const SIDEBAR_BORDER = "rgba(147,197,253,0.2)";
const ACCENT = "#3b82f6";
...
export function DeepBlue() {
  return (
    <div style={{ fontFamily: "'Poppins', sans-serif" }} className="flex h-screen bg-slate-50 overflow-hidden text-slate-800">
      ...
      <aside className="w-64 flex-shrink-0 flex flex-col text-white relative z-20" style={{ backgroundColor: SIDEBAR_BG }}>
        <div className="p-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs font-medium uppercase tracking-wider mt-0.5" style={{ color: SIDEBAR_SUBTEXT }}>JSS Portal</p>
          </div>
        </div>
        ...
        <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
          {[
            ...
            <a key={label} href="#" className="flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors"
              style={{ backgroundColor: active ? SIDEBAR_ACTIVE_BG : "transparent", color: active ? "white" : SIDEBAR_TEXT, border: active ? `1px solid ${SIDEBAR_BORDER}` : "1px solid transparent" }}>
        ...
        <div className="p-4 mt-auto">
          ...
          <div className="mt-4 pt-4 flex items-center gap-3 px-4 pb-2" style={{ borderTop: `1px solid ${SIDEBAR_BORDER}` }}>
            <Avatar className="h-10 w-10"><AvatarImage src="https://i.pravatar.cc/150?u=teacher" /><AvatarFallback className="bg-blue-800 text-white">TR</AvatarFallback></Avatar>
            <div className="flex-1 overflow-hidden">
              <p className="text-sm font-semibold truncate text-white">Teacher Jane</p>
              <p className="text-xs truncate" style={{ color: SIDEBAR_SUBTEXT }}>Admin</p>
            </div>
            <button style={{ color: SIDEBAR_SUBTEXT }}><LogOut className="h-5 w-5" /></button>
          </div>
        </div>
      </aside>
            ...
            <div className="grid grid-cols-3 gap-8">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" className="text-blue-600 font-semibold rounded-full">View All</Button>
                </div>
              ...
              <div className="col-span-2 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" className="text-blue-600 font-semibold rounded-full">Full Leaderboard</Button>
                </div>
