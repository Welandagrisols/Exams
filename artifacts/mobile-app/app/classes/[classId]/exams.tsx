  ...
  return (
    <View style={{ flex: 1 }}>
      <FlatList
        ...
        contentContainerStyle={!data?.length ? { flex: 1 } : { paddingTop: 12, paddingBottom: 96 }}
        data={data ?? []}
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            <Text style={styles.emptyText}>
              {canWrite ? "No exams for this class yet.\nTap + to create one." : "No exams for this class yet."}
            </Text>
          </View>
        }
        renderItem={({ item }) => (
      ...
      />
      {canWrite && (
        <TouchableOpacity style={styles.fab} onPress={() => router.push(`/exams/bulk-create?classId=${classId}`)}>
