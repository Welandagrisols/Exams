...
export default function StudentsExcelScreen() {
  ...
  const pickFile = async () => {
    try {
      ...
      // Read the file as base64 via expo-file-system. Unlike fetch(uri).arrayBuffer(),
      // this reliably handles both file:// and content:// URIs (the latter is what
      // Android's document picker returns) in both dev and production builds.
