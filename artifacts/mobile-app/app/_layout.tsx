          ...
          <AuthProvider>
            <KeyboardProvider>
              ...
              >
                ...
                />
                <Stack.Screen
                  name="classes/[classId]/edit"
                  options={{ title: "Edit Class", headerBackTitle: "Back" }}
                />
                <Stack.Screen
                  name="classes/new"
                  options={{ title: "New Class", headerBackTitle: "Back", presentation: "modal" }}
                />
                <Stack.Screen
                  name="exams/bulk-create"
                  options={{ title: "Bulk Create Exam", headerBackTitle: "Back", presentation: "modal" }}
                />
                <Stack.Screen
                  name="exams/[examId]/share-reports"
                  options={{ title: "Share Reports", headerBackTitle: "Back" }}
                />
                <Stack.Screen
                  name="admin/users"
                  options={{ title: "Users & Roles", headerBackTitle: "Back" }}
                />
                <Stack.Screen
                  name="admin/school-settings"
                  options={{ title: "School Settings", headerBackTitle: "Back" }}
                />
                <Stack.Screen
                  name="admin/learning-areas"
                  options={{ title: "Learning Areas", headerBackTitle: "Back" }}
                />
                <Stack.Screen
                  name="admin/activity-log"
                  options={{ title: "Activity Log", headerBackTitle: "Back" }}
                />
                <Stack.Screen
                  name="search"
