...
type Mode = "options" | "email" | "email_sent";
        ...
        {mode === "email_sent" && (
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <button
              ...
              className="text-xs text-[#1e3a5f] underline mt-1"
            >
        ...
        {mode === "options" && (
          <div className="flex flex-col gap-3 w-full">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-lg px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {loading ? (
        ...
        {mode === "email" && (
          <form onSubmit={handleMagicLink} className="flex flex-col gap-3 w-full">
            ...
            <button
              ...
              className="w-full bg-[#1e3a5f] text-white rounded-lg px-4 py-3 text-sm font-medium hover:bg-[#163050] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
            >
